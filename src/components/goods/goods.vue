<template>
  <div>
    <div class="goods">
        ...
        <ul>
          <li v-for="(item,index) in goods" class="menu-item" :class="{'current':currentIndex === index}"
            ...
            <span class="text border-1px">
              <sticker v-show="item.type>0" :size="3" :type="item.type"></sticker>{{item.name}}
            </span>
          </li>
        </ul>
      </div>
      ...
      <shopcart :select-foods="selectFoods" :delivery-price="seller.deliveryPrice" :min-price="30"
                ref="shopcart"></shopcart>
    </div>
    <food :food="selectedFood" @cartAddFirst="_drop" ref="food"></food>
  </div>
</template>
